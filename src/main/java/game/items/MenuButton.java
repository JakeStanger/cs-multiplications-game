...
public class MenuButton extends GameItem
{
	...
	private static final Material MAT_DESELECTED = new Material(new Vector3f(0.6f, 0, 0.8f), BUTTON_REFLECTANCE);
	private static final Material MAT_SELECTED = new Material(new Vector3f(0.8f, 0.0f, 0.8f), BUTTON_REFLECTANCE);
