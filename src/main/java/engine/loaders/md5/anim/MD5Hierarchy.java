...
public class MD5Hierarchy
{
	...
	public String toString()
	{
		...
		for (MD5HierarchyData hierarchyData : hierarchyDataList) str.append(hierarchyData).append(System.lineSeparator());
	...
	public static MD5Hierarchy parse(List<String> blockBody)
	{
		...
		for (String line : blockBody)
		{
			...
			if (hierarchyData != null) hierarchyDataList.add(hierarchyData);
		}
