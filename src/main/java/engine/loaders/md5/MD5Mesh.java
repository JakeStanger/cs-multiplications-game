...
/**
 * @author Jake stanger
 * Some nasty MD5 animated model mesh processing stuff.
 */
public class MD5Mesh
{
	...
	public static MD5Mesh parse(List<String> meshBlock)
	{
		...
		for (String line : meshBlock)
		{
			if (line.contains("shader"))
			{
				...
				if (textureMatcher.matches()) mesh.setTexture(textureMatcher.group(1));
			}
	...
	public static class MD5Vertex
	{
		...
		private int startWeight, weightCount;
	...
	{
		private int index, vertex0, vertex1, vertex2;
