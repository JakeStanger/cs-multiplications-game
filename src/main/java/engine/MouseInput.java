...
/**
 * @author Jake stanger
 * Handles any mouse input and
 * the mouse position
 */
public class MouseInput
{
	private final Vector2d currentPos, previousPos;
	...
	public void input(Window window)
	{
		...
		if(previousPos.x > 0 && previousPos.y > 0 && this.inWindow)
		{
			...
			if(rotX) displVec.y = (float) deltaX;
			if(rotY) displVec.x = (float) deltaY;
		}
